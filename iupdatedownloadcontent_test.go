...
func TestIUpdateDownloadContent_StructureFields(t *testing.T) {
	content := &IUpdateDownloadContent{
		DownloadUrl: "https://example.com/update.cab",
	}
	if content.DownloadUrl != "https://example.com/update.cab" {
