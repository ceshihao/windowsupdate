...
func toIUpdateDownloadResult(iUpdateDownloadResultDisp *ole.IDispatch) (*IUpdateDownloadResult, error) {
	if iUpdateDownloadResultDisp == nil {
		return nil, nil
	}
	var err error
	...
	if result.HResult, err = toInt32Err(oleutil.GetProperty(iUpdateDownloadResultDisp, "HResult")); err != nil {
		return nil, err
	}
	if result.ResultCode, err = toInt32Err(oleutil.GetProperty(iUpdateDownloadResultDisp, "ResultCode")); err != nil {
		return nil, err
	}
	return result, nil
}
